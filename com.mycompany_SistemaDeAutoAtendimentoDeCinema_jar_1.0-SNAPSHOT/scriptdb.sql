...
CREATE TABLE IF NOT EXISTS `cinema`.`servicos_has_produtos` (
  `servicos_id` INT(11) NOT NULL,
  `servicos_clientes_id` INT(11) NOT NULL,
  `produtos_id` INT(11) NOT NULL,
  `quantidade` INT(11) NOT NULL,
  PRIMARY KEY (`servicos_id`, `servicos_clientes_id`, `produtos_id`),
  INDEX `fk_servicos_has_produtos_produtos1_idx` (`produtos_id` ASC) VISIBLE,
  INDEX `fk_servicos_has_produtos_servicos1_idx` (`servicos_id` ASC, `servicos_clientes_id` ASC) VISIBLE,
  CONSTRAINT `fk_servicos_has_produtos_servicos1`
    FOREIGN KEY (`servicos_id` , `servicos_clientes_id`)
    REFERENCES `cinema`.`servicos` (`id` , `clientes_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_servicos_has_produtos_produtos1`
    FOREIGN KEY (`produtos_id`)
    REFERENCES `cinema`.`produtos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
